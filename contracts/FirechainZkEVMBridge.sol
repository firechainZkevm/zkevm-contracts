 ...
 */
contract FirechainZkEVMBridge is
    DepositContract,
    EmergencyManager,
    IFirechainZkEVMBridge
{
    ...
    // FirechainZkEVM address
    address public firechainZkEVMaddress;

    /**
     * @param _networkID networkID
     * @param _globalExitRootManager global exit root manager address
     * @param _firechainZkEVMaddress firechainZkEVM address
     * @notice The value of `_firechainZkEVMaddress` on the L2 deployment of the contract will be address(0), so
    ...
    modifier onlyFirechainZkEVM() {
        if (firechainZkEVMaddress != msg.sender) {
            revert OnlyFirechainZkEVM();
        }
        _;
    }
     ...
     */
    function activateEmergencyState() external onlyFirechainZkEVM {
     ...
     */
    function deactivateEmergencyState() external onlyFirechainZkEVM {
