...
import "../FirechainZkEVMGlobalExitRoot.sol";

/**
 * Contract responsible for managing the exit roots across multiple networks

 */
contract FirechainZkEVMGlobalExitRootMock is FirechainZkEVMGlobalExitRoot {
    /**
    ...
    ) FirechainZkEVMGlobalExitRoot(_rollupAddress, _bridgeAddress) {}
