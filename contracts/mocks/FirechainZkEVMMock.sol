 ...
 * To enter and exit of the L2 network will be used a FirechainZkEVM Bridge smart contract
 */
contract FirechainZkEVMMock is FirechainZkEVM {
    /**
    ...
    function getNextSnarkInput(
        ...
        if (pendingStateNum != 0) {
            ...
            require(
                ...
                "FirechainZkEVM::verifyBatches: pendingStateNum must be less or equal than lastPendingState"
            );
            ...
            require(
                ...
                "FirechainZkEVM::verifyBatches: initNumBatch must match the pending state batch"
            );
        } else {
            ...
            require(
                ...
                "FirechainZkEVM::verifyBatches: initNumBatch state root does not exist"
            );

            // Check initNumBatch is inside the range
            require(
                initNumBatch <= currentLastVerifiedBatch,
                "FirechainZkEVM::verifyBatches: initNumBatch must be less or equal than currentLastVerifiedBatch"
            );
        }
        ...
        require(
            ...
            "FirechainZkEVM::verifyBatches: finalNewBatch must be bigger than currentLastVerifiedBatch"
        );
    ...
    function trustedVerifyBatchesMock(
        ...
        //     "FirechainZkEVM::verifyBatches: INVALID_PROOF"
        // );
