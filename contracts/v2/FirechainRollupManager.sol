...
import "./interfaces/IFirechainRollupManager.sol";
import "./interfaces/IFirechainZkEVMGlobalExitRootV2.sol";
import "../interfaces/IFirechainZkEVMBridge.sol";
import "./interfaces/IFirechainRollupBase.sol";
import "../interfaces/IVerifierRollup.sol";
import "../lib/EmergencyManager.sol";
import "@openzeppelin/contracts-upgradeable/token/ERC20/utils/SafeERC20Upgradeable.sol";
import "./lib/FirechainTransparentProxy.sol";
import "./lib/FirechainAccessControlUpgradeable.sol";
import "./lib/LegacyZKEVMStateVariables.sol";
import "./consensus/zkEVM/FirechainZkEVMExistentEtrog.sol";
import "./lib/FirechainConstantsBase.sol";
 ...
 */
contract FirechainRollupManager is
    FirechainAccessControlUpgradeable,
    EmergencyManager,
    LegacyZKEVMStateVariables,
    FirechainConstantsBase,
    IFirechainRollupManager
{
     ...
     */
    struct RollupData {
        IFirechainRollupBase rollupContract;
        uint64 chainID;
        IVerifierRollup verifier;
        uint64 forkID;
    ...
    IFirechainZkEVMGlobalExitRootV2 public immutable globalExitRootManager;

    // FirechainZkEVM Bridge Address
    IFirechainZkEVMBridge public immutable bridgeAddress;
     ...
     */
    constructor(
        IFirechainZkEVMGlobalExitRootV2 _globalExitRootManager,
        IERC20Upgradeable _pol,
        IFirechainZkEVMBridge _bridgeAddress
    ) {
     ...
     * @param firechainZkEVM New deployed Firechain zkEVM which will be initialized wiht previous values
    ...
    function initialize(
        ...
        FirechainZkEVMExistentEtrog firechainZkEVM,
        ...
        RollupData storage currentZkEVM = _addExistingRollup(
            IFirechainRollupBase(firechainZkEVM),
            zkEVMVerifier,
            zkEVMForkID,
            zkEVMChainID,
        ...
        // Initialize firechain zkevm
        firechainZkEVM.initializeUpgrade(
            _legacyAdmin,
    ...
    function createNewRollup(
        ...
        rollup.rollupContract = IFirechainRollupBase(rollupAddress);
        ...
        IFirechainRollupBase(rollupAddress).initialize(
            admin,
            sequencer,
            rollupID,
            gasTokenAddress,
    ...
    function addExistingRollup(
        IFirechainRollupBase rollupAddress,
        IVerifierRollup verifier,
        uint64 forkID,
        uint64 chainID,
        bytes32 genesis,
    ...
    /**
     * @notice Function to activate emergency state, which also enables the emergency mode on both FirechainRollupManager and FirechainZkEVMBridge contracts
    ...
    /**
     * @notice Function to deactivate emergency state on both FirechainRollupManager and FirechainZkEVMBridge contracts
     */
        ...
        onlyRole(_STOP_EMERGENCY_ROLE)
    {
        ...
        // Deactivate emergency state on FirechainZkEVMBridge
    ...
    /**
     * @notice Internal function to activate emergency state on both FirechainRollupManager and FirechainZkEVMBridge contracts
     */
    function _activateEmergencyState() internal override {
        // Activate emergency state on FirechainZkEVM Bridge
