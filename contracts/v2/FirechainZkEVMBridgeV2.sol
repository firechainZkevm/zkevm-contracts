...
/**
 * FirechainZkEVMBridge that will be deployed on Ethereum and all Firechain rollups
 * Contract responsible to manage the token interactions with other networks
 */
contract FirechainZkEVMBridgeV2 is
    DepositContractV2,
    EmergencyManager,
    IFirechainZkEVMBridgeV2
{
    ...
    IBaseFirechainZkEVMGlobalExitRoot public globalExitRootManager;
    ...
    // Rollup manager address, previously FirechainZkEVM
    /// @custom:oz-renamed-from firechainZkEVMaddress
    address public firechainRollupManager;
     ...
     * @param _firechainRollupManager firechainZkEVM address
     * @notice The value of `_firechainRollupManager` on the L2 deployment of the contract will be address(0), so
    ...
    function initialize(
        ...
        firechainRollupManager = _firechainRollupManager;
    ...
    modifier onlyRollupManager() {
        if (firechainRollupManager != msg.sender) {
