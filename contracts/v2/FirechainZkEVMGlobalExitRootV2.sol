...
import "./lib/FirechainZkEVMGlobalExitRootBaseStorage.sol";
 ...
 */
contract FirechainZkEVMGlobalExitRootV2 is
    FirechainZkEVMGlobalExitRootBaseStorage,
    DepositContractBase
{
    ...
    function getRoot()
        public
        view
        override(DepositContractBase, IFirechainZkEVMGlobalExitRootV2)
        returns (bytes32)
    {
