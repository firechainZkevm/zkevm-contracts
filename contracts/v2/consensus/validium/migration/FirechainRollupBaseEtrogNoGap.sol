...
import "../../../interfaces/IFirechainZkEVMVEtrogErrors.sol";
import "../../../FirechainRollupManager.sol";
import "../../../interfaces/IFirechainRollupBase.sol";
import "../../../interfaces/IFirechainZkEVMBridgeV2.sol";
 ...
 */
abstract contract FirechainRollupBaseEtrogNoGap is
    Initializable,
    FirechainConstantsBase,
    IFirechainZkEVMVEtrogErrors,
    IFirechainRollupBase
{
    ...
    IBaseFirechainZkEVMGlobalExitRoot
    ...
    IFirechainZkEVMBridgeV2 public immutable bridgeAddress;

    // Rollup manager
    FirechainRollupManager public immutable rollupManager;
    ...
    constructor(
        ...
        IFirechainZkEVMBridgeV2 _bridgeAddress,
        FirechainRollupManager _rollupManager
    ) {
    ...
    function generateInitializeTransaction(
        ...
        bytes memory initializeBrigeData = abi.encodeCall(
            IFirechainZkEVMBridgeV2.initialize,
            (
                networkID,
                _gasTokenAddress,
                _gasTokenNetwork,
