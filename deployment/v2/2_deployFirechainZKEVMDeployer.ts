...
import {deployFirechainZkEVMDeployer} from "../helpers/deployment-helpers";
...
async function main() {
    ...
    // Deploy FirechainZkEVMDeployer if is not deployed already using keyless deployment
    ...
    if (keylessDeployer === ethers.ZeroAddress) {
        console.log("#######################\n");
        console.log("firechainZkEVMDeployer already deployed on: ", zkEVMDeployerContract.target);
    } else {
        console.log("#######################\n");
        console.log("firechainZkEVMDeployer deployed on: ", zkEVMDeployerContract.target);
    }
