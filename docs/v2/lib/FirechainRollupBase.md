...
```solidity
  function sequenceBatches(
    struct FirechainRollupBase.BatchData[] batches,
    address l2Coinbase
  ) public
```
...
| Name | Type | Description                                                          |
| :--- | :--- | :------------------------------------------------------------------- |
|`batches` | struct FirechainRollupBase.BatchData[] | Struct array which holds the necessary data to append new batches to the sequence
...
```solidity
  function sequenceForceBatches(
    struct FirechainRollupBase.ForcedBatchData[] batches
  ) external
```
...
| Name | Type | Description                                                          |
| :--- | :--- | :------------------------------------------------------------------- |
|`batches` | struct FirechainRollupBase.ForcedBatchData[] | Struct array which holds the necessary data to append force batches
