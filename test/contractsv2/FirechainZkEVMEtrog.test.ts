...
describe("FirechainZkEVMEtrog", () => {
    ...
    let FirechainZKEVMV2Contract: FirechainZkEVMEtrog;
    ...
    it("should check full flow", async () => {
        ...
        // Approve tokens
        await expect(
            polTokenContract.connect(trustedSequencer).approve(FirechainZKEVMV2Contract.target, maticAmount * 100n)
        ...
        ).to.be.revertedWithCustomError(FirechainZKEVMV2Contract, "InitSequencedBatchDoesNotMatch");
